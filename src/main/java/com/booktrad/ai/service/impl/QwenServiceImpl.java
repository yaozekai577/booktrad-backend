        ...
        try {
            ...
            Message systemMsg = Message.builder()
                    ...
                    .content("你是BookTrad二手书交易平台的AI智能助手。你的职责是：\n" +
                            ...
                            "4. 协助处理订单、支付等相关问题\n\n" +
                            "重要提示：\n" +
                            "- 当用户询问某个技术或学科的知识时（如\"Java\"、\"Python\"等），你应该：\n" +
                            "  1) 简要介绍该技术/学科（2-3句话）\n" +
                            "  2) 说明学习该技术通常需要哪些类型的书籍（如入门教材、进阶书籍等）\n" +
                            "  3) 引导用户使用智能搜索功能，例如：\"如果您想在平台上找相关书籍，可以试试：'我要Java书籍'或'推荐Java教材'\"\n" +
                            "- 不要推荐具体的书名，因为你不知道平台上有哪些书\n" +
                            "- 只有用户明确表示要搜索书籍时，系统才会查询数据库\n" +
